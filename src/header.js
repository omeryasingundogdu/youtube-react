...
import { IconMicrophone, IconSearch, IconPlus, IconBell } from '@tabler/icons-react';
...
export default function Header() {
  ...
  const notifications = [
    {
      ...
      avatar: AvatarImage,  
      channel: 'user1',
      content: 'Your comment got a ❤️ from user1!',
      time: '9 hours ago',
      thumbnail: 'https://placehold.co/128x68',
      category: 'important'
    },
    {
      id: 2,
      ...
      avatar: AvatarImage,
      channel: 'user2',
      content: 'Your comment got a ❤️ from user2!',
      time: '17 hours ago',
      thumbnail: 'https://placehold.co/128x68/000000/FFF',
      category: 'important'
    },
    {
      id: 3,
      ...
      time: '1 day ago',
      thumbnail: 'https://placehold.co/128x68/EEE/31343C?font=lora&text=video',
      category: 'important'
    },
    {
      id: 4,
      ...
      content: 'lorem ipsum',
      time: '15 hours ago',
      thumbnail: 'https://placehold.co/128x68/EEE/31343C?font=lora&text=test%20video%20:)',
      category: 'more'
    },
    {
      id: 5,
      ...
      avatar: 'https://via.placeholder.com/40x40',
      channel: 'user5',
      content: 'user5 liked your comment: "lorem ipsum"',
      time: '15 hours ago',
      thumbnail: 'https://placehold.co/128x68/EEE/31343C?font=lora&text=test%20video%20:)',
      category: 'more'
    }
  ...
  const toggleNotifications = () => {
    ...
    if (createMenuOpened) setCreateMenuOpened(false);
  };

  const toggleCreateMenu = () => {
    setCreateMenuOpened(!createMenuOpened);
    ...
    >
      <Group spacing="xs">
        ...
        <Link to="/" style={{ textDecoration: 'none' }}>
          <svg xmlns="http://www.w3.org/2000/svg" width="93" height="20" viewBox="0 0 93 20" focusable="false" style={{ display: 'block', cursor: 'pointer' }}>
            <g>
          ...
          <Input
            ...
            rightSection={
              <ActionIcon 
                ...
                variant="filled" 
                color="dark" 
                style={{ backgroundColor: "#222222", border: "none" }}
      ...
      <Group spacing="md">
        <Box style={{ position: 'relative' }}>
          ...
          <CreateMenu visible={createMenuOpened} onItemClick={handleCreateMenuItemClick} />
        </Box>
        ...
        <Box style={{ position: 'relative' }}>
          ...
          <Notifications visible={notificationsOpened} notifications={notifications} />
        </Box>
        ...
        <Box style={{ position: 'relative' }}>
          ...
          <ProfileMenu visible={profileMenuOpened} onItemClick={handleProfileMenuItemClick} />
        </Box>
      </Group>
    </Flex>
  );
